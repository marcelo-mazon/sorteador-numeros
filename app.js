function sortear(){
    ...
    if (de >= ate){
        alert('Valor "Do número" deve ser inferior ao valor "Até o número"!');
        return;
    }

    if(quantidade > (ate - de + 1)){
        alert('"Quantidade de números" deve ser menor ou igual ao intervalo "Do número" a "Até o número"!');
        return;
    }
